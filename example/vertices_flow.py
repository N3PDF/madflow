...
def FFV1_1(F2,V3,COUP,M1,W1):
    ...
    F13= denom*(-im)*(F2[2]*(P1[0]*(-V3[3]+im*(V3[4]))+(P1[1]*(V3[2]-V3[5])+(P1[2]*(-im*(V3[2])+im*(V3[5]))+P1[3]*(V3[3]-im*(V3[4])))))+(F2[3]*(P1[0]*(V3[2]+V3[5])+(P1[1]*(-1)*(V3[3]+im*(V3[4]))+(P1[2]*(im*(V3[3])-V3[4])-P1[3]*(V3[2]+V3[5]))))+M1*(F2[4]*(-V3[3]+im*(V3[4]))+F2[5]*(-V3[2]+V3[5]))))
    F14= denom*(-im)*(F2[4]*(P1[0]*(V3[2]+V3[5])+(P1[1]*(-V3[3]+im*(V3[4]))+(P1[2]*(-1)*(im*(V3[3])+V3[4])-P1[3]*(V3[2]+V3[5]))))+(F2[5]*(P1[0]*(V3[3]+im*(V3[4]))+(P1[1]*(-V3[2]+V3[5])+(P1[2]*(-im*(V3[2])+im*(V3[5]))-P1[3]*(V3[3]+im*(V3[4])))))+M1*(F2[2]*(-V3[2]+V3[5])+F2[3]*(V3[3]+im*(V3[4])))))
...
def FFV1_2(F1,V3,COUP,M2,W2):
    ...
    F22= denom*im*(F1[2]*(P2[0]*(V3[2]+V3[5])+(P2[1]*(-1)*(V3[3]+im*(V3[4]))+(P2[2]*(im*(V3[3])-V3[4])-P2[3]*(V3[2]+V3[5]))))+(F1[3]*(P2[0]*(V3[3]-im*(V3[4]))+(P2[1]*(-V3[2]+V3[5])+(P2[2]*(im*(V3[2])-im*(V3[5]))+P2[3]*(-V3[3]+im*(V3[4])))))+M2*(F1[4]*(V3[2]-V3[5])+F1[5]*(-V3[3]+im*(V3[4])))))
    F23= denom*(-im)*(F1[2]*(P2[0]*(-1)*(V3[3]+im*(V3[4]))+(P2[1]*(V3[2]+V3[5])+(P2[2]*(im*(V3[2]+V3[5]))-P2[3]*(V3[3]+im*(V3[4])))))+(F1[3]*(P2[0]*(-V3[2]+V3[5])+(P2[1]*(V3[3]-im*(V3[4]))+(P2[2]*(im*(V3[3])+V3[4])+P2[3]*(-V3[2]+V3[5]))))+M2*(F1[4]*(V3[3]+im*(V3[4]))-F1[5]*(V3[2]+V3[5]))))
    F24= denom*(-im)*(F1[4]*(P2[0]*(-V3[2]+V3[5])+(P2[1]*(V3[3]+im*(V3[4]))+(P2[2]*(-im*(V3[3])+V3[4])+P2[3]*(-V3[2]+V3[5]))))+(F1[5]*(P2[0]*(V3[3]-im*(V3[4]))+(P2[1]*(-1)*(V3[2]+V3[5])+(P2[2]*(im*(V3[2]+V3[5]))+P2[3]*(V3[3]-im*(V3[4])))))+M2*(F1[2]*(-1)*(V3[2]+V3[5])+F1[3]*(-V3[3]+im*(V3[4])))))
...
def VVV1P0_1(V2,V3,COUP,M1,W1):
    ...
    denom = COUP/(P1[0]**2-P1[1]**2-P1[2]**2-P1[3]**2 - M1 * (M1 -im* W1))
    V12= denom*(TMP5*(-im*(P2[0])+im*(P3[0]))+(V2[2]*(-im*(TMP1)+im*(TMP2))+V3[2]*(im*(TMP3)-im*(TMP4))))
    V13= denom*(TMP5*(-im*(P2[1])+im*(P3[1]))+(V2[3]*(-im*(TMP1)+im*(TMP2))+V3[3]*(im*(TMP3)-im*(TMP4))))
    V14= denom*(TMP5*(-im*(P2[2])+im*(P3[2]))+(V2[4]*(-im*(TMP1)+im*(TMP2))+V3[4]*(im*(TMP3)-im*(TMP4))))
    V15= denom*(TMP5*(-im*(P2[3])+im*(P3[3]))+(V2[5]*(-im*(TMP1)+im*(TMP2))+V3[5]*(im*(TMP3)-im*(TMP4))))
